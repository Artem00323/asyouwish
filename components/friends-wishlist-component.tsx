        ...
        <CardContent className="p-6">
          <div className="flex flex-col space-y-4">
            <div className="relative">
              ...
              {isDropdownOpen && (
                <div className="absolute left-0 right-0 top-[100%] mt-1 bg-white rounded-lg border shadow-lg z-50">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {declinedRequests.map((request) => (
              <Card key={request.user_id} className="p-4 bg-gray-50">
                <div className="flex items-center gap-3">
                  <Avatar className="h-10 w-10">
                    <AvatarImage src={request.avatar_url || '/avatars/default.png'} />
                    <AvatarFallback>{request.name[0]}</AvatarFallback>
        ...
        {friends.length > 0 ? (
          ...
          <Card className="p-8 text-center bg-gray-50">
            <div className="flex flex-col items-center gap-3">
              ...
              <h4 className="text-lg font-medium text-gray-600">No Friends Yet</h4>
